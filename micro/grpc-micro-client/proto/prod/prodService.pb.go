...
func (x *ProdoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdoRequest) ProtoMessage() {}

func (x *ProdoRequest) ProtoReflect() protoreflect.Message {
	mi := &file_prodService_proto_msgTypes[0]
...
// Deprecated: Use ProdoRequest.ProtoReflect.Descriptor instead.
func (*ProdoRequest) Descriptor() ([]byte, []int) {
	return file_prodService_proto_rawDescGZIP(), []int{0}
}

func (x *ProdoRequest) GetSize() int32 {
	if x != nil {
		return x.Size
	}
	return 0
...
var file_prodService_proto_rawDesc = []byte{
	...
	,
...
var file_prodService_proto_goTypes = []interface{}{
	(*ProdoRequest)(nil), // 0: prod.ProdoRequest
	(*ProdResponse)(nil), // 1: prod.ProdResponse
	(*ProdModel)(nil),    // 2: prod.ProdModel
}
var file_prodService_proto_depIdxs = []int32{
	2, // 0: prod.ProdResponse.data:type_name -> prod.ProdModel
	0, // 1: prod.ProdService.GetProdList:input_type -> prod.ProdoRequest
	1, // 2: prod.ProdService.GetProdList:output_type -> prod.ProdResponse
