...
type ProdService interface {
	GetProdList(ctx context.Context, in *ProdRequest, opts ...client.CallOption) (*ProdResponse, error)
...
func (c *prodService) GetProdList(ctx context.Context, in *ProdRequest, opts ...client.CallOption) (*ProdResponse, error) {
...
type ProdServiceHandler interface {
	GetProdList(context.Context, *ProdRequest, *ProdResponse) error
...
func RegisterProdServiceHandler(s server.Server, hdlr ProdServiceHandler, opts ...server.HandlerOption) error {
	type prodService interface {
		GetProdList(ctx context.Context, in *ProdRequest, out *ProdResponse) error
...
func (h *prodServiceHandler) GetProdList(ctx context.Context, in *ProdRequest, out *ProdResponse) error {
